...
(defn install [wiki]
  ...
  ;;(wiki/add-handler ""     "plugin.core.show-page")
  ;;(wiki/add-handler "NEW"  "plugin.core.new-page" )
  ;;(wiki/add-handler "LIST" "plugin.core.list-page")
  ;;(wiki/add-handler "EDIT" "plugin.core.edit-page")
  ;;(wiki/add-hook    "show" "plugin.core.edit-page")
  ;;(wiki/add-handler "DIFF" "plugin.core.diff"     )
  ;;(wiki/add-hook    "show" "plugin.core.diff"     )
